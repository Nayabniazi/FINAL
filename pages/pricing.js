...
Our pricing estimator even allows you to estimate based on the space your junk will take up in our large removal trucks. Get an affordable estimate in just minutes!
  ...
  <span className="circle-number">1</span> Click the green "Launch Pricing Estimator" button above.
</h6>
                                        ...
                                        <div className="col-lg-6 mb-30">
                                        <h6 className="color-brand-2 mb-10 wow animate__animated animate__fadeIn">
  <span className="circle-number">2</span> Enter your zip code and follow the prompts.
</h6>
                                        ...
                                        <div className="col-lg-6 mb-30">
                                        <h6 className="color-brand-2 mb-10 wow animate__animated animate__fadeIn">
  <span className="circle-number">3</span> Choose your estimation method: select items individually or estimate by truck load.
</h6>
                                        ...
                                        <div className="col-lg-6 mb-30">
                                        <h6 className="color-brand-2 mb-10 wow animate__animated animate__fadeIn">
  <span className="circle-number">4</span>  Enter your contact info and let’s get started!
</h6>
                                        ...
                                        <div className="col-lg-6 mb-30">
                                        <h6 className="color-brand-2 mb-10 wow animate__animated animate__fadeIn">
  <span className="circle-number">5</span> Add your items or specify the number of pickup truck loads.
</h6>
                                        ...
                                        <h6 className="color-brand-2 mb-10 wow animate__animated animate__fadeIn">
  <span className="circle-number">6</span> Click "Book It" to schedule your junk removal!
</h6>
                    ...
                    <div className="container position-relative">
                        ...
                        <div className="row mt-50">
                            <div className="col-lg-6">
                                ...
                                <h6 className="color-brand-2 mb-10 wow animate__animated animate__fadeIn">
  <span className="circle-number">1</span> Online Pricing Estimator
</h6>
                                ...
                                <div className="item-faqs-2 mb-30">
                                <h6 className="color-brand-2 mb-10 wow animate__animated animate__fadeIn">
  <span className="circle-number">2</span>  On-Site Pricing
</h6>
                            ...
                            <div className="item-faqs-2 mb-30">
                            <h6 className="color-brand-2 mb-10 wow animate__animated animate__fadeIn">
  <span className="circle-number">3</span>  Text Us a Photo
</h6>
                                ...
                                <div className="item-faqs-2 mb-30">
                                <h6 className="color-brand-2 mb-10 wow animate__animated animate__fadeIn">
  <span className="circle-number">4</span>  Call or Live Chat
</h6>
