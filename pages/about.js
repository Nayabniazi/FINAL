                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-6"><span className="btn btn-tag wow animate__animated animate__fadeIn"style={{backgroundColor:'orange'}}>Get in touch</span>
                                ...
                                <p className="font-md color-grey-900 mb-40 wow animate__animated animate__fadeIn">BinBear is more than just a junk removal company; we are a partner in your efforts to keep your home and community clean. With full-service removal and self-service dumpster rental options, we provide a flexible solution tailored to your needs. Whether you’re cleaning out your home, handling an estate cleanout, or working on a renovation, BinBear offers reliable, professional, and eco-conscious junk removal.
                                </p>
                                <div className="row">
                                    <div className="col-lg-6 mb-30">
