                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6"><span className="btn btn-tag wow animate__animated animate__fadeIn" style={{color: 'white', backgroundColor:'orange'}}>Get in
                            ...
                            <div className="mt-20"><Link className="btn btn link mr-20 wow animate__animated animate__fadeIn" href="/contact" style={{color: 'black', backgroundColor: 'orange',width:'150px'}}>Contact Us</Link><Link className="btn btn-link-medium wow animate__animated animate__fadeIn"style={{color:'white'}} href="#">Learn More
