            ...
            <section className="section bg-leading-company pt-95">
                ...
                <div className="container"style={{backgroundColor:'black',}}>
                    <div className="text-center mb-45">
                        <h2 className="color-brand-1 mb-15 wow animate__animated animate__fadeIn"><br className="d-none d-lg-block" />World’s Leading Companies</h2>
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6 col-sm-6 mb-30">
                            <div className="cardLeadingCompany"style={{backgroundColor:'orange'}}>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6 mb-30">
                            <div className="cardLeadingCompany"style={{backgroundColor:'orange'}}>
                                ...
                                <div className="cardInfo">
                                    <h3 className="color-white wow animate__animated animate__fadeIn"><span>+</span><span className="count">{inViewport && <CountUp end={457} duration={10} />}</span></h3>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6 mb-30">
                            <div className="cardLeadingCompany"style={{backgroundColor:'orange'}}>
                                ...
                                <div className="cardInfo">
                                    <h3 className="color-white wow animate__animated animate__fadeIn"><span>+</span><span className="count">{inViewport && <CountUp end={384} duration={10} />}</span></h3>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6 mb-30">
                            <div className="cardLeadingCompany"style={{backgroundColor:'orange'}}>
                                ...
                                <div className="cardInfo">
                                    <h3 className="color-white wow animate__animated animate__fadeIn"><span>+</span><span className="count">{inViewport && <CountUp end={483} duration={10} />}</span></h3>
