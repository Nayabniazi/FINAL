...
export default function Header({ topBarStyle, handleMobileMenuOpen }) {
                    ...
                    <div className="container position-relative">
                        <div className="row align-items-center">
                            <div className="col-lg-7 col-md-8 col-sm-5 col-4"> <Link className="phone-icon mr-45" href="tel:+01-246-357">
                                ...
                                </svg>Phone: 1-888-888-JUNK  (Any time 24/7)</Link><Link className="email-icon" href="mailto:contact@transp.eu.com">
                                    <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <div className="col-  mb-30 text-md-end text-start"style={{marginTop:'40px'}}><Link className="btn btn-brand-1 hover-up" href="/404" style={{backgroundColor: 'orange', }}>
                            <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
